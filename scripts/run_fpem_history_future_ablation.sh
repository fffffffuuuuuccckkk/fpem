...
export RELATION_MAPPING_MODE=legacy
export EXPERIMENT_TAG=hf_v1

for mode in off stable_only adaptive_unit adaptive_gated; do
  export FUTURE_MAPPING_MODE="$mode"
